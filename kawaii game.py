...
# Background
background = pygame.image.load("backgrounda.png")

# Caption and Icon
pygame.display.set_caption("Space Invader")
icon = pygame.image.load('charatera.png')
pygame.display.set_icon(icon)

# Player
playerImg = pygame.image.load('charatera.png')
...
for _i in range(num_of_enemies):
    enemyImg.append(pygame.image.load('enemya.png'))
...
# Bullet
bulletImg = pygame.image.load('bulleta.png')
bulletX = 0
